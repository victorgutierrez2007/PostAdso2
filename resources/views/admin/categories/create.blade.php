        ...
        <div class="max-w-4xl mx-auto">
            <div class="mb-8">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-4xl font-bold text-gray-900 dark:text-white">{{ __('Crear Categoría') }}</h1>
                        <p class="text-gray-600 dark:text-gray-400 mt-1">{{ __('Agregar una nueva categoría a tu tienda') }}</p>
                    </div>
                </div>
            </div>
